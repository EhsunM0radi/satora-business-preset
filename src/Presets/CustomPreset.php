...
class CustomPreset extends AbstractBusinessPreset
{
    protected string $code = 'custom';

    protected string $name = 'Custom Business';

    protected ?string $description = 'Start from scratch and build your store exactly the way you want. Full flexibility.';
